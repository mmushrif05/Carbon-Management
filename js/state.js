...
let state = { role:null, name:'', uid:null, organizationId:null, organizationName:null, projectId:null, projectName:null, page:'dashboard', entries:[], a5entries:[], invitations:[], tenderScenarios:[], organizations:[], orgLinks:[], assignments:[], users:[], projects:[], projectFirms:[] };
